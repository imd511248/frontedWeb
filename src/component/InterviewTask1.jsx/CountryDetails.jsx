        ...
        {state.map((item, i) => {
          return (
            <div
              ...
              className={`group md:w-1/4 xl:w-1/5 w-full h-16 text-center rounded-3xl leading-none py-4 border cursor-pointer hover:bg-green-700 relative text-lg md:text-xl bg-red-400`}>
              {item.city}
